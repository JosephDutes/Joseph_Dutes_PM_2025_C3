...
printf("\nLa cadena cad1 es: ");
printf("%s", cad1);
// La fucnion printf, con el formato de variable %s, tambien se puede utilizar para escribir cadenas de caracteres. baja automaticamente una linea despues de escribir la cadena. */
...
// se utiliza la funcion getchar para leer caracteres de la linea de texto y asignarlos a la variable de tipo cadena de caracteres cad6. Observa que se leen caracteres mientras no se encuentre al caracter que indica fin de la linea '\n'.
while ((p = getchar())!= '\n')
    cad6[i++] = p;
cad6[i] = '\0';
