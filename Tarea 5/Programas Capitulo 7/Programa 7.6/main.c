#include <stdio.h>
#include <string.h>
// funciones d la biblioteca string.h para el manejo de cadenas de caracteres
void main(void)
{
...
printf("\nPrubea de la funcion strcpy. Se copia la cadena cad0 a cad1: %s\n", cad1);
strcpy(cad1, cad3);
printf("\nPrueba de la cadena strcpy. Se copia la cadena cad3 a cad1: %s\n", cad1);
strcpy(cad1, "XX");
...
strcat(cad2, " ");
strncat(cad2, cad0, 4);
printf("\nPrueba de la funcion strncat. Se incoporan 4 caracteres de cad0 a cad2: %s\n", cad2);
