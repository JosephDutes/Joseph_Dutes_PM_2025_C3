...
/* Empresa textil.
 ...
 /* La función Lectura se utiliza para leer un arreglo tridimensional de tipo real de Filas, Columnas y Planos de profundidad. */
 {
 int K, I, J;
 for(K=0; K<P; K++)
 for (I=0; I<F; I++)
 for(J=0; J<C; J++)
 {
 printf("\nAno: %d\tMes: %d\tDepartamento: %d ", K+1, I+1, J+1);
 scanf("%f", &A[I][J][K]);
 }
 }
