...
int MAT[MAX][MAX], TRA[MAX][MAX];
 ...
 do
 {
 printf("vIngrese el numero de filas de la matriz: ");
 scanf("%d", &FIL);
 }
 while (FIL > MAX || FIL < 1);
 ...
 /* Esta función se utiliza para escribir una matriz de tipo entero de Filas y Columnas —en este caso la traspuesta. */
 {
 int I, J;
 for (I=0; I<F; I++)
 for (J=0; J<C; J++)
