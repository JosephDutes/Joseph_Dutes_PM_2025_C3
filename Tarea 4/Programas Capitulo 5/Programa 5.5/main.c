 #include <stdio.h>
/* Frecuencia de calificaciones. El programa al recibir como datos las calificaciones de un grupo de 50 alumnos, obtiene la frecuencia de cada una de las calificaciones y ademas escribe cual es la frecuencia mas alta */
const int TAM = 50;
...
Lectura(CAL, TAM); /* Se llama a la fucion lectura */
Frecuencia(CAL, TAM, FRE, 6);
/* Se llama a la funcion frecuencia, se pasan ambos areglos. */
...
/* Esta funcion calcula la frcuencia de calificaciones */
{
    int I;
    for (I=0; I<P; I++)
